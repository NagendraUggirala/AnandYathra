          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mb-8">
            ...
            <div className="footer-about">
              ...
              <p className="text-gray-300 mb-4 text-sm sm:text-base leading-relaxed">
                Your trusted partner for spiritual journeys and pilgrimage tours.
                We provide seamless travel experiences to sacred destinations with
                comfort, devotion, and cultural immersion across India.
              </p>
